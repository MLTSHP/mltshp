...
define('aws_pass', metavar="AWS_PASS", help="AWS Host")
define('aws_secret', metavar="SECRET", help="Amazon API secret for S3 & Payments")
define('aws_bucket', metavar="NAME", default="mltshp-development", help="Name of Amazon S3 bucket to use")
...
define('hoptoad_enabled', type=bool, default=False, help="Report errors to hoptoad")
define('hoptoad_api_key', metavar="KEY", help="Hoptoad API key")
