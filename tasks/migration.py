...
def migrate_for_user(user_id=0, **kwargs):
    ...
    logging.info("Migrating user_id %s..." % str(user_id))

    logging.info("- app records")
    ...
    # conversation
    logging.info("- conversation records")
    ...
    # invitation_request
    logging.info("- invitation_request records")
    ...
    # notification
    logging.info("- notification records")
    ...
    # shake_manager
    logging.info("- shake_manager records")
    ...
    # shakesharedfile
    logging.info("- shakesharedfile records")
    ...
    # sharedfile
    logging.info("- sharedfile records")
    ...
    # magicfile
    logging.info("- magicfile records")
    ...
    # subscription
    logging.info("- subscription records")
    ...
    # tagged_file
    logging.info("- tagged_file records")
    ...
    # via a script
    logging.info("- user/migration_state update")
    ...
    logging.info("- Migration for user %s complete!" % str(user_id))
