...
routes = [
    ...
    (r"/account/upgrade", handlers.account.UpgradeHandler),
    #(r"/account/payment/return", handlers.account.PaymentReturnHandler),
    #(r"/account/payment/process", handlers.account.PaymentProcessHandler),
    (r"/account/payment/cancel", handlers.account.PaymentCancelHandler),
    (r"/account/subscribe", handlers.account.SubscriptionHandler),
    ...
    (r"/browserconfig.xml", handlers.misc.BrowserConfigHandler),
