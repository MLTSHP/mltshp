...
class ShakeModelTests(BaseTestCase):
    ...
    def test_correct_page_image_is_returned(self):
        ...
        self.assertEqual('/static/images/default-icon-venti.png', self.user.shake().page_image())
        self.shake.image = 1
        self.shake.save
    ...
    def test_correct_thumbnail_url_is_returned(self):
        ...
        """
        self.assertEqual('/static/images/default-icon-venti.png', self.shake.thumbnail_url())
        self.assertEqual('/static/images/default-icon-venti.png', self.user.shake().thumbnail_url())
        self.shake.image = 1
        self.shake.save()
